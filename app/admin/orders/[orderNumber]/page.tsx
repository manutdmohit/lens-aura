      ...
      <AdminLayout>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <Link href="/admin/orders" className="text-sm text-gray-500 hover:text-gray-900 flex items-center mb-2">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <Badge variant="outline" className={getStatusBadgeColor(order.payment.status)}>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div>
                      ...
                      >
                        <SelectTrigger className="w-[180px]">
                          <SelectValue>
                            <Badge variant="outline" className={getDeliveryStatusBadgeColor(order.delivery.status)}>
                              {order.delivery.status ? order.delivery.status.split('_').map(word => word.charAt(0) + word.slice(1).toLowerCase()).join(' ') : 'Order Placed'}
                            </Badge>
                          </SelectValue>
                        </SelectTrigger>
                        <SelectContent>
                          {DELIVERY_STATUSES.map((status) => (
                            <SelectItem key={status} value={status}>
                              <Badge variant="outline" className={getDeliveryStatusBadgeColor(status)}>
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-medium">{new Date(order.delivery.updatedAt).toLocaleDateString()}</p>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p>{new Date(order.dates.created).toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="whitespace-pre-line">{order.shipping.fullAddress}</p>
                </div>
              </CardContent>
            </Card>
          </div>
