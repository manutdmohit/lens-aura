                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900 text-sm">
                              Premium {formatText(product.lensType)} Lenses
                            </h4>
                      ...
                      <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-xs mt-1">
                              Built-in UV blocking technology for eye protection
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs mt-1">
                            Keep glasses away from extreme heat which can damage
                            frames and lenses
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs mt-1">
                            Always store your glasses in their case when not in
                            use
                          </p>
                        </div>
                      </div>
                ...
                <div>
                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6">
                    <p className="text-gray-700 text-sm">
                      All glasses come with a 1-year manufacturer warranty
                      against defects. Contact us immediately if you encounter
                      any issues with your glasses.
                    </p>
                  </div>
