            ...
            <motion.div variants={slideUp} className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-200">
                <div className="p-4 space-y-3">
                  ...
                  {product.frameType && (
                    <div className="flex justify-between">
                      <span className="text-gray-500 text-sm">Frame Shape</span>
                      <span className="font-medium text-sm text-gray-900">
                        {formatText(product.frameType)}
                      </span>
                    </div>
                ...
                <div className="p-4 space-y-3">
                  {product.lensType && (
                    <div className="flex justify-between">
                      <span className="text-gray-500 text-sm">Lens Type</span>
                      <span className="font-medium text-sm text-gray-900">
                  ...
                  {product.prescriptionType && (
                    <div className="flex justify-between">
                      <span className="text-gray-500 text-sm">Prescription Type</span>
                      <span className="font-medium text-sm text-gray-900">
                  ...
                  {product.frameWidth && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-sm text-gray-900">{formatText(product.frameWidth)}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="p-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                {product.gender && (
                  <div className={`flex flex-col items-center justify-center p-4 rounded-xl bg-green-50 text-green-700`}>
                    ...
                    <span className="text-xs">{formatText(product.gender)}</span>
                  </div>
                )}
              </div>
            </motion.div>
                    ...
                    {product.lensType && (
                      <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <div className="flex items-start">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900 text-sm">Premium {formatText(product.lensType)} Lenses</h4>
                            <p className="text-gray-600 text-xs mt-1">High-quality lenses for optimal vision</p>
                          </div>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-xs mt-1">Built-in UV blocking technology for eye protection</p>
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 flex flex-col items-center text-center">
                      ...
                      <h4 className="font-medium text-gray-900 text-sm">Glasses Frame</h4>
                      <p className="text-gray-600 text-xs mt-1">
                        {product.name} frame with lenses
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 flex flex-col items-center text-center">
                      ...
                      <p className="text-gray-600 text-xs mt-1">
                        Durable case to protect your glasses
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs mt-1">Keep glasses away from extreme heat which can damage frames and lenses</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-xs mt-1">Always store your glasses in their case when not in use</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6">
                    <p className="text-gray-700 text-sm">
                      All glasses come with a 1-year manufacturer warranty against defects. Contact us immediately if you encounter any issues with your glasses.
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    <p className="text-gray-700 text-sm mb-4">
                      We want you to be completely satisfied with your purchase. If you're not happy with your glasses for any reason, we offer a simple return and exchange policy.
                    </p>
