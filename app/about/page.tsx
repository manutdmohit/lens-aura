...
export const metadata = {
  ...
  description:
    'Learn about Lens Aura, our mission, and our commitment to providing premium eyewear in Australia.',
  openGraph: {
    title: 'About Us | Lens Aura',
    description:
      'Learn about Lens Aura, our mission, and our commitment to providing premium eyewear in Australia.',
...
export default async function AboutPage() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col space-y-12">
      {/* Header */}
      <div className="container mx-auto px-4 pt-16 pb-6 text-center">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">{heading}</h1>
        <p className="text-base md:text-xl text-gray-600">{subtitle}</p>
      </div>

      {/* Vision Section */}
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-16 py-8 md:py-16">
      ...
      {/* Values Section */}
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 py-12">
